...
// FIX: Wrap in an IIFE to prevent global scope pollution and variable redeclaration errors.
(() => {
    const App = () => {
        ...
        const LOGO_URL = 'https://operacaolabirintar.github.io/Reposit-rio-de-Imagens/IMG_5430.png';
        ...
        const createHeader = () => { // This is now just the title section
            return createElement('header', {
                children: [
        ...
        const createFooter = () => {
            const logoImg = createElement('img', {
             ...
             const copyrightText = createElement('p', {
                ...
                textContent: '© 2025 LABirintar. Todos os direitos reservados.'
            });
            return createElement('footer', {
                className: 'main-footer',
                children: [logoImg, copyrightText]
            });
        };
